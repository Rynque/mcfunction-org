<template>
  <footer class="mx-auto max-w-screen-xl bg-gray-50 border-b-4 border-b-gray-100">
    <div class="px-6 md:px-12 py-6 flex flex-col md:flex-row justify-between space-y-2 md:items-center md:space-y-0">
      ...
      <div class="text-[10px]/3 text-gray-600 space-y-2 md:text-right">
        <p>本站不是 Minecraft 官方网站。未经 Mojang 或 Microsoft 批准，也不与 Mojang 或 Microsoft 关联。</p>
        <p>提出你的想法帮我们改进网站：<a class="underline" href="mailto:support@mcfunction.org">support@mcfunction.org</a></p>
      </div>
    </div>
  </footer>
</template>